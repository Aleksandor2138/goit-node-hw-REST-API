...
//     beforeAll(async ()=> {await mongoose.connect(HOST_TEST_URI), await User.deleteMany();});
//     afterAll(async () => {
//         await mongoose.disconnect(HOST_TEST_URI)
//     });

//     test("test-register", async () => {
//         const { body, statusCode } = await request(app).post("/api/users/register").send(newUser);
